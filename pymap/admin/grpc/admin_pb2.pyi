...
class Login(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> Login: ...
...
class AppendRequest(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"login"]) -> bool: ...
        ...
        def HasField(self, field_name: typing_extensions___Literal[u"login",b"login"]) -> bool: ...
